...
#Leer archivo de variables de entorno
...
#SECRET_KEY = 'django-insecure-2akz+jf6&qpfk#8cs87sq4mxg7dc_=%+-_l5pba3)69938(eot'
...
CORS_ALLOWED_ORIGINS = [
    "http://localhost:3000",  # Origen de tu frontend en React
]